...
/**
 * factory의 품질 신호를 구독한다({@code factory/quality/#}).
 *
 * <p>factory는 QMS의 주소를 모른다 — 토픽에 던질 뿐이고 관심 있는 모듈이 각자 붙는다.
 */
@Component
public class MqttEventSubscriber implements MqttCallbackExtended {
    ...
    public void connect() {
        ...
        try {
            ...
            // cleanSession=false — QMS가 잠깐 내려가 있는 동안의 검사 요청도 재접속 후 받는다.
            ...
            log.warn("Could not connect MQTT subscriber to {}. Inspection requests will not arrive.",
