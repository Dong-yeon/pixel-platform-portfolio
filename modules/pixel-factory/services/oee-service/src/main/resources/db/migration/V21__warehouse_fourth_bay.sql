...
-- 반드시 같이 채워야 한다(V18과 같은 값 2000mm). **P29(V20)에서 이걸 빠뜨려 프로덕션
-- 배포가 한 번 깨졌다** — 같은 실수를 여기서도 반복하지 않도록 명시해 둔다.
insert into layout_edges (from_node, to_node, base_cost, bidirectional, width_mm, created_at, updated_at) values
    ...
    ('JCT-19-U', 'JCT-19-L', 9, true, 2000, now(), now()),
...
insert into layout_edges (from_node, to_node, base_cost, bidirectional, width_mm, created_at, updated_at) values
    ...
    ('JCT-14-U', 'JCT-19-U', 11, true, 2000, now(), now()),
    ('JCT-19-U', 'WH-GATE-U', 15, true, 2000, now(), now()),
    ...
    ('JCT-14-L', 'JCT-19-L', 11, true, 2000, now(), now()),
    ('JCT-19-L', 'WH-GATE-L', 15, true, 2000, now(), now()),
...
insert into layout_edges (from_node, to_node, base_cost, bidirectional, width_mm, created_at, updated_at) values
    ...
    ('WH-SHIP-2',  'JCT-19-L', 3, true, 2000, now(), now()),
